...
const InventoryHeader = ({ onImportClick, onAddClick, onSearch }) => {
    return (
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <div className="flex flex-wrap gap-3">
                    <button
                        ...
                        className="flex items-center gap-2 bg-teal-600 hover:bg-teal-700 text-white font-bold py-2 px-4 rounded-lg shadow cursor-pointer transition transform hover:scale-105"
                        id="import-csv-open-btn"
                    >
                        <Upload size={18} />
                        Import Obat
                    </button>
